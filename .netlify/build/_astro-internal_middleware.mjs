...
import { createClerkRequest, constants, AuthStatus, createRedirect, signedOutAuthObject, getAuthObjectFromJwt } from "@clerk/backend/internal";
...
import "kleur/colors";
import { A as AstroError, R as ResponseSentError, o as originPathnameSymbol, F as ForbiddenRewrite } from "./chunks/astro/server_DMQip7Ni.mjs";
import "clsx";
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_Y3VkZGx5LWdpYmJvbi0yNi5jbGVyay5hY2NvdW50cy5kZXYk", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_vHsst07x8216OuRu0rLIFjiSNMz03nDkiIKgYZykPF", Path: process.env.Path, PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.9.0"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.9.0",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_vHsst07x8216OuRu0rLIFjiSNMz03nDkiIKgYZykPF", Path: process.env.Path, PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
...
var createGetAuth = ({ noAuthStatusMessage }) => {
  return (req, locals, { treatPendingAsSignedOut = true, ...opts } = {}) => {
    ...
    return getAuthObjectFromJwt(decodeJwt(authToken), { ...options, treatPendingAsSignedOut });
  };
};
